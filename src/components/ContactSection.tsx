      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <h2 className="font-serif text-3xl md:text-5xl font-bold text-foreground mb-4">
            Book Your <span className="gold-text">Site Visit</span>
          </h2>
          <p className="font-sans text-muted-foreground max-w-xl mx-auto">
            Visit our projects and experience the quality firsthand. Our team will guide you through every detail.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          >
            ...
            >
              ...
              <Button className="w-full bg-secondary text-secondary-foreground hover:bg-secondary/90 font-sans uppercase tracking-wider py-6">
                Book Site Visit
              </Button>
            </form>
          </motion.div>
          ...
          >
            <div className="grid sm:grid-cols-2 gap-4">
              <a href="tel:+919999999999" className="glass-card rounded-xl p-5 flex items-center gap-3 hover-lift">
              ...
              <a
                ...
                className="glass-card rounded-xl p-5 flex items-center gap-3 hover-lift"
              >
              ...
              <a href="mailto:info@shreedhargroup.com" className="glass-card rounded-xl p-5 flex items-center gap-3 hover-lift">
                <div className="w-10 h-10 rounded-lg bg-accent/10 flex items-center justify-center">
            ...
            <div className="rounded-xl overflow-hidden border border-border h-64 md:h-80">
              <iframe
                ...
                title="Shreedhar Group Location"
              />
            </div>
          </motion.div>
        </div>
