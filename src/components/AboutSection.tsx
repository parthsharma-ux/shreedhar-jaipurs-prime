      ...
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="bg-card rounded-xl p-6 border-l-4 border-l-gold shadow-premium">
              ...
              <span className="font-sans text-sm text-gold font-semibold uppercase tracking-wider">
          ...
          >
            {values.map((v, i) => (
              <motion.div
                ...
                className="bg-card rounded-xl p-5 flex items-center gap-4 hover-lift shadow-premium cursor-default border border-border"
              >
