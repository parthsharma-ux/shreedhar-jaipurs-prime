...
import { MapPin, Maximize, IndianRupee, ArrowRight, X, Download, Building2 } from "lucide-react";
...
const projects = [
  {
    ...
    description: "A premium gated plotting project offering world-class amenities in the heart of Bhankrota. Perfect for families seeking a peaceful yet connected lifestyle.",
  },
  {
    ...
    description: "An ultra-premium residential project with resort-style living. Enjoy modern amenities while being minutes from Ajmer Road connectivity.",
  },
  {
    ...
    description: "Successfully delivered plotting project with 100% possession given. A testimony to our commitment to on-time delivery.",
  },
  {
    ...
    description: "A thoughtfully planned residential project with Vastu-compliant plots and sustainable infrastructure for modern families.",
  },
];
...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className="section-padding navy-gradient" ref={ref}>
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="font-sans text-primary-foreground/60 max-w-xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {projects.map((p, i) => (
            <motion.div
              ...
              className="card-3d glass-dark rounded-2xl p-6 md:p-8 cursor-pointer group"
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p className="font-sans text-primary-foreground/50 text-sm flex items-center gap-1">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="flex items-center gap-2 text-primary-foreground/70 font-sans text-sm">
              ...
              <div className="flex items-center justify-between">
                <div className="flex gap-2 flex-wrap">
                  {p.amenities.slice(0, 3).map((a) => (
                    <span
                      key={a}
                      className="text-xs font-sans text-primary-foreground/40 bg-primary-foreground/5 px-2 py-1 rounded"
                    >
                      {a}
                    </span>
                  ))}
          ...
          {selected && (
            <>
              ...
              <div className="space-y-6 mt-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selected.amenities.map((a) => (
                      <span
                        key={a}
                        className="font-sans text-sm bg-accent/10 text-accent-foreground px-3 py-1.5 rounded-full border border-accent/20"
                      >
                        {a}
                      </span>
                    ))}
                ...
                <Button className="w-full bg-secondary text-secondary-foreground hover:bg-secondary/90 font-sans uppercase tracking-wider">
